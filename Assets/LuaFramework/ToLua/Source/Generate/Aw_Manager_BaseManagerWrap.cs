...
public class Aw_Manager_BaseManagerWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(Aw.Manager.BaseManager), typeof(BaseBehaviour));
	...
	static int get_isOnUpdate(IntPtr L)
	{
		...
		try
		{
			...
			Aw.Manager.BaseManager obj = (Aw.Manager.BaseManager)o;
