...
public class LuaFramework_LuaManagerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("FocusMain", FocusMain);
		L.RegFunction("QuitMain", QuitMain);
		L.RegFunction("PauseMain", PauseMain);
		L.RegFunction("UpdateMain", UpdateMain);
		L.RegFunction("DestroyMain", DestroyMain);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int UpdateMain(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int DestroyMain(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
